...
class etcInfoViewModel: ObservableObject {
    @Published var Sharearr: [etcInfoModel] = [
        etcInfoModel(category: "ahha", title: "yaho", subtitle: "hihi", content: "haha", imageName: "..", authorRole: 2, isAnonymous: true),
        etcInfoModel(category: "ahha", title: "yaho", subtitle: "hihi", content: "haha", imageName: "..", authorRole: 2, isAnonymous: true)
    ]
...
struct EditorRichText: UIViewRepresentable {
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        var parent: EditorRichText
        
        init(_ parent: EditorRichText) {
            self.parent = parent
        }
...
struct PickerImage: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
        let parent: PickerImage
        
        init(_ parent: PickerImage) {
            self.parent = parent
        }
