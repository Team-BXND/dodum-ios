...
struct ShareDetailView: View {
    @StateObject var DetailVM : ShareViewModel
    ...
    var body: some View {
            ...
            ScrollView {
                ZStack(alignment: .topTrailing) {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        // DetailVM에서 HTML -> AttributedString 변환
                        Text(DetailVM.attributedContent(from: item.content))
                            .font(.body)
        ...
        .onAppear{
            Task{
                await DetailVM.fetchDetail(id: id)
            }
        }
